  ...
  return (
    <main className={cn(styles.main)}>
      ...
      <div className={cn(styles.result_game_wrapper)}>
        ...
        <div className={cn(styles.wrong)}>
          <div className={cn(styles.dont_know)}>
            <h3 className={cn(styles.wrong_heading)}>Не знаю</h3>
          ...
          <div className={cn(styles.words)}>
            <div className={cn(styles.word)}>
              <img
                ...
                alt="megaphone"
              />
              <p className={cn(styles.eng_bald_word)}>duck</p>—
